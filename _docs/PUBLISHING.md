...
現状: **v0.1.0 MVP**。NeoForge 1.21.1 (ルート) / 1.21.4 / 1.21.8 / 1.21.11 / 26.2、Forge 1.21.1 / 1.20.1、Fabric 1.20.1 / 1.21.1 / 1.21.4 / 1.21.8 / 1.21.11 の構成。
...
- [ ] 全 `build/libs/compasstomapxaeros-x.y.z.jar` のサイズ確認（compileOnly が混入してないこと）
- [ ] 全 jar に `LICENSE_compasstomapxaeros` が同梱されてること (`unzip -l <jar> | grep LICENSE`)
...
| Loaders × MC | NeoForge 1.21.1 (ルート) / 1.21.4 / 1.21.8 / 1.21.11 / 26.2、Forge 1.21.1 / 1.20.1、Fabric 1.20.1 / 1.21.1 / 1.21.4 / 1.21.8 / 1.21.11 |
