...
/**
 * Compass to Map: Xaero's edition - Fabric 26.2 Mod entry (server / common 側)。
 *
...
public class CompassToMapXaerosFabric implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        // 26.2: fabric-api の PayloadTypeRegistry#playS2C/playC2S は
        // clientboundPlay/serverboundPlay に改名された (javap 実測、fabric-api 0.155.2+26.2)。
        ...
        CompassToMapXaeros.LOGGER.info("Compass to Map: Xaero's edition (Fabric 26.2) initialized");
    }
}
