...
/**
 * Compass to Map: Xaero's edition - Fabric 1.21.1 Client entry。
 *
...
public class CompassToMapXaerosClientFabric implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        CompassToMapXaeros.LOGGER.info("Compass to Map: Xaero's edition (Fabric 1.21.1 client) initialized");
    }
}
